...
document.querySelector("#matchstart").addEventListener('click', async function(){
    ...
    await loadJavascript('js/cardcalc_steam/cardocr.js?v=10300018');
});
...
document.querySelector('#finishyes').addEventListener('click', async function(){
    ...
    await loadJavascript('js/cardcalc_steam/cardcalcul.js?v=10300018');
...
if(getCookie('savecarddeck') != ''){
    (async ()=>{
        ...
        await loadJavascript('js/cardcalc_steam/cardeffect.js?v=10300018');
