...
document.querySelector("#matchstart").addEventListener('click', async function(){
    ...
    await loadJavascript('js/cardcalc_steam/cardocr.js?v=04201242');
});
...
document.querySelector('#finishyes').addEventListener('click', async function(){
    ...
    await loadJavascript('js/cardcalc_steam/cardcalcul.js?v=04201242');
...
if(getCookie('savecarddeck_steam') != ''){
    (async ()=>{
        ...
        await loadJavascript('js/cardcalc_steam/cardeffect.js?v=04201242');
