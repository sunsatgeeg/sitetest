...
document.querySelector("#matchstart").addEventListener('click', async function(){
    ...
    await loadJavascript('js/cardcalc/cardocr.js?v=08262013');
});
...
document.querySelector('#finishyes').addEventListener('click', async function(){
    ...
    await loadJavascript('js/cardcalc/cardcalcul.js?v=08262013');
...
if(getCookie('savecarddeck') != ''){
    (async ()=>{
        ...
        await loadJavascript('js/cardcalc/cardeffect.js?v=08262013');
