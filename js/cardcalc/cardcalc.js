...
document.querySelector("#matchstart").addEventListener('click', async function(){
    ...
    await loadJavascript('js/cardcalc/cardocr.js?v=02152003');
});
...
document.querySelector('#finishyes').addEventListener('click', async function(){
    ...
    await loadJavascript('js/cardcalc/cardcalcul.js?v=02152003');
...
if(getCookie('savecarddeck') != ''){
    (async ()=>{
        ...
        await loadJavascript('js/cardcalc/cardeffect.js?v=02152003');
