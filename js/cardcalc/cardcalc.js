...
document.querySelector("#matchstart").addEventListener('click', async function(){
    ...
    await loadJavascript('js/cardcalc/cardocr.js?v=04041712');
});
...
document.querySelector('#finishyes').addEventListener('click', async function(){
    ...
    await loadJavascript('js/cardcalc/cardcalcul.js?v=04041712');
...
if(getCookie('savecarddeck') != ''){
    (async ()=>{
        ...
        await loadJavascript('js/cardcalc/cardeffect.js?v=04041712');
