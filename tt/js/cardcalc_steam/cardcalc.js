...
document.querySelector("#matchstart").addEventListener('click', async function(){
    ...
    await loadJavascript('js/cardcalc_steam/cardocr.js?v=11200153');
});
...
document.querySelector('#finishyes').addEventListener('click', async function(){
    ...
    await loadJavascript('js/cardcalc_steam/cardcalcul.js?v=11200153');
...
if(getCookie('savecarddeck_steam') != ''){
    (async ()=>{
        ...
        await loadJavascript('js/cardcalc_steam/cardeffect.js?v=11200153');
